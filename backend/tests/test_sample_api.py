...
from tests.helpers import FixedVectorEmbeddingService, make_test_database, write_silent_wav
...
def test_search_endpoint_returns_ranked_results(tmp_path: Path) -> None:
    ...
    database.embedding_service = FixedVectorEmbeddingService([0.3, 0.9, 0.0, 0.0])
