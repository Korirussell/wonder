    ...
    <nav className="relative z-70 flex h-14 shrink-0 items-center justify-between border-b-2 border-[#2D2D2D] bg-[#FDFDFB] px-6 hard-shadow">
      <div className="flex items-center gap-8">
        ...
        <div className="hidden gap-6 md:flex">
          <a
            href="#"
            className="border-b-2 border-[#C1E1C1] pb-0.5 font-headline text-sm font-bold text-[#2D2D2D]"
          >
            Studio
          </a>
          <a
            href="#"
            className="font-headline text-sm font-bold text-[#2D2D2D]/50 transition-colors hover:text-[#2D2D2D]"
          >
            Library
          </a>
          <a
